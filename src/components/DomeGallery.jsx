          ...
          {vignette && (
            <>
              <div
                ...
                style={{
                  backgroundImage: `radial-gradient(circle, transparent 50%, var(--overlay-blur-color, ${overlayBlurColor}) 85%, var(--overlay-blur-color, ${overlayBlurColor}) 100%)`
                }}
              />
              <div
                className="absolute inset-0 m-auto z-3 pointer-events-none"
                style={{
                  WebkitMaskImage: `radial-gradient(circle, transparent 55%, var(--overlay-blur-color, ${overlayBlurColor}) 85%)`,
                  maskImage: `radial-gradient(circle, transparent 55%, var(--overlay-blur-color, ${overlayBlurColor}) 85%)`,
