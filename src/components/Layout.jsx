    ...
    <div className="min-h-screen bg-white flex flex-col">
      <header className="border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link to={user ? '/home' : '/'} className="text-xl font-semibold text-gray-900">
            Game Store
          </Link>
      ...
      <main className={isLanding ? 'flex-1 w-full p-0 min-h-0 flex' : 'flex-1 max-w-6xl w-full mx-auto px-4 py-8'}>
        <Outlet />
      </main>
      {user && (
